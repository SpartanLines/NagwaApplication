...
//string whatcolor(color r)
//{
//	if (r.ucRed == 255 & r.ucBlue <= 125 & r.ucGreen <= 125) return "red";
//	if (r.ucBlue == 255 & r.ucGreen <= 125 & r.ucRed <= 125) return "blue";
//	if (r.ucGreen == 255 & r.ucBlue <= 125 & r.ucRed <= 125) return "green";
//	if (r.ucRed >= 125 & r.ucBlue >= 125) return "purple";
//	if (r.ucRed == 255 & r.ucGreen >= 125 & r.ucGreen <= 175) return "orange";
//	if (r.ucRed == 255 & r.ucGreen >= 175 | r.ucGreen == 255 & r.ucRed >= 175) return "yellow";
//	if (r.ucGreen >= 125 & r.ucBlue >= 125) return "cyan";
//	else return "no_fill";
//
//}
//enum shapes

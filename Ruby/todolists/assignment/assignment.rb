...
class Assignment
  ...
  def create_user(params)
      ...
      testUser=User.create(username:params[:username],password_digest:params[:password_digest])
  ...
  def find_allusers(offset, limit)
      ...
      allusers=User.offset(offset).limit(limit)
  end
  ...
  def find_alllists(offset, limit)
      ...
      alllists=TodoList.order(list_due_date: :desc).offset(offset).limit(limit)
  end
  ...
  def find_user_byname(username)
      ...
      samename=User.where( username: username)
  ...
  def find_todolist_byname(name)
    ...
    samename=TodoList.where(list_name: name)
  ...
  def update_password(id, password_digest)
      ...
      myperson=User.find(id)
      myperson.password_digest=password_digest
      myperson.save
